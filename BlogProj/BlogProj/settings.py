...
SECRET_KEY = 'django-insecure-688rn=!tc+@i+p$q5dkmx5o$ho$4-=vnmjlt+pg8j-65qv)3&r'
...
CKEDITOR_5_CUSTOM_CSS =  os.path.join(BASE_DIR /   'static/django_ckeditor_5/dist/admin_darkmode.css') # optional
CKEDITOR_5_CONFIGS = {
    "default": {
        "toolbar": [
            "heading",
